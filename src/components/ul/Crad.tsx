...
const RecentCard = ({ post } : {post : IPost}) => {
  const { title, category, images, city,dateFound } = post || {};

  return (
    <NextUiCard isFooterBlurred className="h-[300px] mt-5 w-full">
      ...
      <Image
        ...
        className="scale-120 z-0 mx-auto p-5 -translate-y-6 object-cover"
        src={images[0]}
        height={400}
        width={300}
      />
